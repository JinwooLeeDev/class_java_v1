...
public class TypingRecord2 {
    ...
    public static void saveRecord(Scanner sc) {
        ...
        try (FileOutputStream fos = new FileOutputStream("C:\\ljw\\workspace\\class_java_v1\\assets\\typing.txt", true)) {
    ...
    public static void printRecord() {
        System.out.println("\n 저장된 기록 ");
        try (FileInputStream fis = new FileInputStream("C:\\ljw\\workspace\\class_java_v1\\assets\\typing.txt")) {
